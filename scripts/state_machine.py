...
initial_pose = PoseStamped()      # Initial position and orientation of the robot in specific frame and time stramp 
...
def main():
    ...
    while not done:
        if have_task == 0: 
            ...
            call(["ros2", "launch", "sofar_assignment", "gz_respawner_stage2.py"])
    ...
    # delete model for next stage
    from subprocess import call
    call(["ros2", "launch", "sofar_assignment", "gz_respawner_stage1.py"])
